          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg text-muted-foreground space-y-4">
                ...
                <p>
                  Our team of certified technicians brings together the best of local knowledge and international expertise. We understand the unique challenges that Bali's climate presents: the high humidity that accelerates algae growth, the monsoon seasons that bring debris and affect water chemistry, and the mineral-rich local water that can cause scaling and equipment issues.
                </p>
                <p>
                  From routine maintenance and cleaning to complex repairs and complete pool installations, we offer comprehensive pool services tailored to Bali's environment. Whether you own a private villa in Ubud, manage a beachfront resort in Seminyak, or operate a boutique hotel in Canggu, our professional team is ready to keep your pool in perfect condition year-round.
                </p>
                <p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">support@poolrepairlab.com</p>
                  </div>
                </div>
              </div>
            </div>
